...
const About = () => {
  ...
  const content = [
    ...
    { key: 'phone', value: '0906366223'},
    { key: 'email', value: 'dvbtrung23@gmail.com'},
    { key: 'instagram', value: 'dvbtrung_'},   
    { key: 'languages', value: 'Vietnamese, English'},   
  ];

  const achievement = [
    { amount: '1', text: 'years of', subText: 'experience'},
    { amount: '5', text: 'completed', subText: 'projects'},
  ...
  return(
    <div className="About container">
      ...
      <div className="row experience mb-5">
        <div className="col-12 title text-center mb-5">experience & education</div>
        {
